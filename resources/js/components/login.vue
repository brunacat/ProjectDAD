  ...
  <div id="login">
    ...
    <b-form>
      <b-form-group id="input-group-1" label="Email address:" label-for="email">
        <b-form-input id="email" v-model="input.email" type="email" required placeholder="Email"></b-form-input>
      </b-form-group>
      ...
      <b-button type="submit" variant="primary" v-on:click.prevent="login()">Login</b-button>
    </b-form>
  </div>
</template>
