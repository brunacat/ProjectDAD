<template>
    <div class="jumbotron">
        ...
        <br />
        <p></p>
        <div v-if="typeP == 'bt' && type == 'Payment'" class="form-group">
        ...
        <div v-if="typeP == 'mb' && type == 'Payment'" class="form-group">
        ...
        <div class="form-group">
            <b-button
                type="save"
                variant="primary"
                v-on:click.prevent="addExpense()"
                >Save</b-button
            >
            <b-button
                type="cancel"
                variant="light"
                v-on:click.prevent="cancelExpense()"
                >Cancel</b-button
            >
        </div>
    </div>
